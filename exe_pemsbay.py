...
from main_model2 import PriSTI_PemsBAY
from utils2 import train, evaluate
from generate_adj import get_similarity_pemsbay
...
def main(args):
    ...
    adj = get_similarity_pemsbay()
    adj = torch.from_numpy(adj).to(args.device)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--nsample", type=int, default=60)

...
from dataset_ele import get_dataloader
from main_model import PriSTI_ELE
...
def main(args):
    ...
    model = PriSTI_ELE(config, args.device).to(args.device)

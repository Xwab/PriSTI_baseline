...
from dataset_metro import get_dataloader
from main_model import PriSTI_Metro
...
def main(args):
    ...
    config["diffusion"]["adj_file"] = 'metro'
    config["seed"] = SEED
    ...
    model = PriSTI_Metro(config, args.device).to(args.device)
